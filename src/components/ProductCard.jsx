const ProductCard = ({ name, description, image }) => (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition w-[80%]  mx-auto">
      <img src={image} alt={name} className="w-50 h-50  object-cover rounded-t-lg" />
      <div className="p-4">
